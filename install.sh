...
claude mcp remove agentforce 2>/dev/null || true
...
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
echo "To use the agent designer:"
echo ""
echo "  1. Launch Claude Code from THIS directory:"
echo "       cd \"$REPO_DIR\""
echo "       claude"
echo ""
echo "  2. Inside Claude Code, type:"
echo "       /agent-designer"
echo ""
echo "Note: the MCP server is registered at project scope, so the"
echo "agent designer is only available when Claude Code is launched"
echo "from this directory."
echo ""
echo "To verify the MCP server loaded, run /mcp inside Claude Code."
echo ""
